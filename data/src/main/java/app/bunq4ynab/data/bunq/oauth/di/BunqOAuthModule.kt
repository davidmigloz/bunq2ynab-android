package app.bunq4ynab.data.bunq.oauth.di

import app.bunq4ynab.data.BuildConfig
import app.bunq4ynab.data.bunq.oauth.BunqOAuthRepositoryImpl
import app.bunq4ynab.data.bunq.oauth.local.BunqOAuthLocalDataSource
import app.bunq4ynab.data.bunq.oauth.local.BunqOAuthLocalDataSourceImpl
import app.bunq4ynab.data.bunq.oauth.remote.BunqOAuthApi
import app.bunq4ynab.data.bunq.oauth.remote.BunqOAuthInterceptor
import app.bunq4ynab.data.bunq.oauth.remote.BunqOAuthRemoteDataSource
import app.bunq4ynab.data.bunq.oauth.remote.BunqOAuthRemoteDataSourceImpl
